...
| `Replace text in selected files` | One or more files are selected in the current directory | Opens a two-field replacement palette for the selected files only. The palette previews affected files before `Enter` applies the replacement. |
