...
| 検索結果モード（ファイル検索/grep検索） | `↑` / `↓` | 結果一覧のカーソル移動 |
| 検索結果モード（ファイル検索/grep検索） | `Ctrl+N` / `Ctrl+P` | 結果一覧のカーソル移動（下/上） |
| 検索結果モード（ファイル検索/grep検索） | `PageUp` / `PageDown` | 1ページ分カーソル移動 |
| 検索結果モード（ファイル検索/grep検索） | `Home` / `End` | 先頭/末尾の結果へ移動 |
| 検索結果モード（ファイル検索/grep検索） | `Enter` | 選択中の結果を開く |
| 検索結果モード（ファイル検索/grep検索） | `Ctrl+E` | 選択中の結果をエディタで開く |
| 検索結果モード（ファイル検索/grep検索） | `Esc` | 検索を閉じる |
